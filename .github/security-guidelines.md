...
- [Security Guidelines for Reusable Workflows](#security-guidelines-for-reusable-workflows)
  ...
  - [Supply Chain Security](#supply-chain-security)
    - [1. Dependency Pinning](#1-dependency-pinning)
  ...
  - [Workflow Security](#workflow-security)
    - [1. Event Triggers](#1-event-triggers)
    - [2. Environment Protection](#2-environment-protection)
    - [3. Token Scoping](#3-token-scoping)
  - [Code Security](#code-security)
    - [1. Static Analysis](#1-static-analysis)
    - [2. Dynamic Analysis](#2-dynamic-analysis)
    - [3. Compliance Scanning](#3-compliance-scanning)
  - [Incident Response](#incident-response)
    - [1. Security Monitoring](#1-security-monitoring)
  ...
  - [Security Testing](#security-testing)
    ...
    - [3. Third-Party Assessment](#3-third-party-assessment)
  - [Recommendations for Different Project Types](#recommendations-for-different-project-types)
