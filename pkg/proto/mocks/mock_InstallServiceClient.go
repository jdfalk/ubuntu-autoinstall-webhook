...
func (_m *MockInstallServiceClient) ReportStatus(ctx context.Context, in *proto.StatusRequest, opts ...grpc.CallOption) (*proto.StatusResponse, error) {
...
func (_c *MockInstallServiceClient_ReportStatus_Call) Run(run func(ctx context.Context, in *proto.StatusRequest, opts ...grpc.CallOption)) *MockInstallServiceClient_ReportStatus_Call {
...
func (_c *MockInstallServiceClient_ReportStatus_Call) Return(_a0 *proto.StatusResponse, _a1 error) *MockInstallServiceClient_ReportStatus_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockInstallServiceClient_ReportStatus_Call) RunAndReturn(run func(context.Context, *proto.StatusRequest, ...grpc.CallOption) (*proto.StatusResponse, error)) *MockInstallServiceClient_ReportStatus_Call {
	_c.Call.Return(run)
	return _c
}
