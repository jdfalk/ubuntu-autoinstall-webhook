...
func (_m *MockConfigService) LoadConfig() (configuration.Config, error) {
	ret := _m.Called()
...
func (_c *MockConfigService_LoadConfig_Call) Return(_a0 configuration.Config, _a1 error) *MockConfigService_LoadConfig_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConfigService_LoadConfig_Call) RunAndReturn(run func() (configuration.Config, error)) *MockConfigService_LoadConfig_Call {
	_c.Call.Return(run)
	return _c
}

// ValidateConfig provides a mock function with given fields: cfg
func (_m *MockConfigService) ValidateConfig(cfg configuration.Config) error {
	ret := _m.Called(cfg)
...
func (_c *MockConfigService_ValidateConfig_Call) Run(run func(cfg configuration.Config)) *MockConfigService_ValidateConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockConfigService_ValidateConfig_Call) RunAndReturn(run func(configuration.Config) error) *MockConfigService_ValidateConfig_Call {
	_c.Call.Return(run)
	return _c
}

// WatchConfigUpdates provides a mock function with no fields
func (_m *MockConfigService) WatchConfigUpdates() (<-chan configuration.Config, error) {
	ret := _m.Called()
...
func (_c *MockConfigService_WatchConfigUpdates_Call) Return(_a0 <-chan configuration.Config, _a1 error) *MockConfigService_WatchConfigUpdates_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConfigService_WatchConfigUpdates_Call) RunAndReturn(run func() (<-chan configuration.Config, error)) *MockConfigService_WatchConfigUpdates_Call {
	_c.Call.Return(run)
	return _c
}
