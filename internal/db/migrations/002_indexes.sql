-- Migration: Add missing columns to fix logging and driver errors
-- For system_logs, add a "timestamp" column if it doesn't already exist.
ALTER TABLE system_logs
ADD COLUMN IF NOT EXISTS "timestamp" TIMESTAMP DEFAULT current_timestamp;
-- For network_interfaces, add a "driver" column if it doesn't already exist.
